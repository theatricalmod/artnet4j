...
public enum PacketType {
    ...
    ART_TOD_REQUEST(0x8000, ArtTodRequestPacket.class),
    ART_TOD_DATA(0x8100, ArtTodDataPacket.class),
    ART_TOD_CONTROL(0x8200, ArtTodControlPacket.class),
    ART_RDM(0x8300, ArtRdmPacket.class),
